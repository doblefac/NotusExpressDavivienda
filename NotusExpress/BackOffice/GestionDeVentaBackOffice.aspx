<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GestionDeVentaBackOffice.aspx.vb" Inherits="NotusExpress.GestionDeVentaBackOffice" %>
                    ...
                    <asp:Panel ID="pnlDatosPersonales" runat="server">
                        <table class="tabla">
                            ...
                            <tr>
                                ...
                                <td valign="middle">
                                    <asp:TextBox ID="txtFiltroCiudad" runat="server" Width="70px" onkeyup="FiltrarDatos(this, 'cpCiudad', this.value, 'hfControlFiltroCiudad')"></asp:TextBox>
                                    ...
                                    <asp:Panel ID="pnlRegistroPreventa" runat="server">
                                        ...
                                        <p>
                                            <asp:LinkButton ID="lblRegistrarPreventa" runat="server" CssClass="search" ValidationGroup="datosPersonales"
                                                OnClientClick="return ValidarDatosYMostrarConfirmacion('datosPersonales', '');"><img src="../img/save_all.png" alt="" />&nbsp;&nbsp;Registrar Datos</asp:LinkButton>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
