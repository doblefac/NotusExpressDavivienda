...
Partial Public Class AdministracionTipificacionNovedades
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents txtFiltroNombre As Global.DevExpress.Web.ASPxTextBox
    ...
    '''<summary>
    '''Control gvListaNovedades.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents gvListaNovedades As Global.DevExpress.Web.ASPxGridView

    '''<summary>
    '''Control pucNuevoCanal.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents pucNuevoCanal As Global.DevExpress.Web.ASPxPopupControl

    '''<summary>
    '''Control pnlDatosCanal.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents pnlDatosCanal As Global.DevExpress.Web.ASPxPanel
    ...
    '''<summary>
    '''Control txtNombreNovedad.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents txtNombreNovedad As Global.DevExpress.Web.ASPxTextBox
    ...
    '''<summary>
    '''Control cbCausalGenerica.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents cbCausalGenerica As Global.DevExpress.Web.ASPxComboBox
