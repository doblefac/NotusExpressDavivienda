<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VisorPlanillaRadicacion.aspx.vb" Inherits="NotusExpress.VisorPlanillaRadicacion" %>
8
...
<head runat="server">
    <title>Planilla Radicación</title>
</head>
<body>
    ...
    <dx:ReportToolbar ID="rtbOpciones" runat='server' ShowDefaultButtons='False' 
        ...
        <dx:ReportViewer ID="rvPicking" runat="server" AutoSize="true">
            <%--Report="<%# new (none)() %>" ReportName="(none)"--%>
        </dx:ReportViewer>
    </form>
</body>
</html>
