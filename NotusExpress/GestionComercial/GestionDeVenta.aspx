<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GestionDeVenta.aspx.vb"
    Inherits="NotusExpress.GestionDeVenta" %>
        ...
        <asp:Panel ID="pnlConsulta" runat="server">
            <table class="tabla" style="width: 70%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtIdentificacionConsulta" runat="server" MaxLength="15" onkeypress="return solonumeros(event);"></asp:TextBox>
                        <div style="display: block">
                            <asp:RequiredFieldValidator ID="rfvIdentificacionConsulta" runat="server" ErrorMessage="No. de Identificaci&oacute;n requerido"
                                ControlToValidate="txtIdentificacionConsulta" Display="Dynamic" 
                ...
                <tr>
                    <td class="field" style="width: 160px">
                        No. de Transacci&oacute;n
                    </td>
                    <td>
                        <asp:TextBox ID="txtTransaccionConsulta" runat="server" MaxLength="15" onkeypress="return solonumeros(event);"></asp:TextBox>&nbsp; La búsqueda por No. de transacción omite el filtro por No. de identificación.
                        <div style="display: block">
        ...
        <asp:Panel ID="pnlGestion" runat="server">
            <eo:TabStrip runat="server" ID="tsInfoGestion" ControlSkinID="None" MultiPageID="mpInfoGestion">
                <TopGroup>
                    <Items>
                        ...
                        <eo:TabItem Text-Html="Histórico de Venta">
                        </eo:TabItem>
                    </Items>
                </TopGroup>
                <LookItems>
            ...
            <eo:MultiPage runat="server" ID="mpInfoGestion">
                <eo:PageView ID="pvDatosCliente" runat="server">
                    ...
                    <asp:Panel ID="pnlDatosPersonales" runat="server">
                        <table class="tabla">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtIdentificacion" runat="server" MaxLength="15" onkeypress="return solonumeros(event);"></asp:TextBox>
                                    <div style="display: block">
                                        <asp:RegularExpressionValidator ID="revIdentificacion" runat="server" ErrorMessage="El dato proporionado tiene formato no v&aacute;lido"
                                            ControlToValidate="txtIdentificacion" Display="Dynamic" ValidationGroup="registroVenta"
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvIdentificacion" runat="server" ErrorMessage="No. de Identificaci&oacute;n requerido"
                                            ControlToValidate="txtIdentificacion" Display="Dynamic" ValidationGroup="registroVenta"></asp:RequiredFieldValidator>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNombreApellido" runat="server" Width="250px" MaxLength="100" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                    <div style="display: block;">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvNombreApellido" runat="server" ErrorMessage="Nombres y Apellidos del cliente requeridos"
                                            ControlToValidate="txtNombreApellido" Display="Dynamic" ValidationGroup="registroVenta"></asp:RequiredFieldValidator>
                                    </div>
                                </td>
                                <td class="field">
                                ...
                                <td valign="middle">
                                    <asp:TextBox ID="txtFiltroCiudad" runat="server" Width="70px" onkeyup="FiltrarDatos(this, 'cpCiudad', this.value, 'hfControlFiltroCiudad')" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                    <eo:CallbackPanel ID="cpCiudad" runat="server" UpdateMode="Group" GroupName="InfoOrigenGestion"
                                        ChildrenAsTriggers="true" AutoDisableContents="True" Style="display: inline"
                                        ClientSideAfterUpdate="CallbackAfterUpdateHandler">
                                        <asp:DropDownList ID="ddlCiudadResidencia" runat="server">
                                        </asp:DropDownList>
                                        <asp:Label ID="lblNumCiudades" runat="server" ForeColor="Gray" Font-Italic="true"
                                            Font-Size="X-Small"></asp:Label>
                                    </eo:CallbackPanel>
                                    <div style="display: block">
                                        <asp:RequiredFieldValidator ID="rfvCiudadResidencia" runat="server" ErrorMessage="Ciudad de residencia requerida"
                                            ControlToValidate="ddlCiudadResidencia" Display="Dynamic" ValidationGroup="registroVenta"></asp:RequiredFieldValidator>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="display: block;">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvDireccionResidencia" runat="server" ErrorMessage="Direcci&oacute;n de residencia requerida"
                                            ControlToValidate="txtDireccionResidencia" Display="Dynamic" ValidationGroup="registroVenta"></asp:RequiredFieldValidator>
                                    </div>
                                </td>
                                <td class="field">
                                    Barrio Residencia
                                ...
                                <td>
                                    ...
                                    <div style="display: block;">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvBarrio" runat="server" ErrorMessage="Barrio de residencia requerida"
                                            ControlToValidate="txtBarrioResidencia" Display="Dynamic" ValidationGroup="registroVenta"></asp:RequiredFieldValidator>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTelefonoResidencia" runat="server" MaxLength="20"  onkeypress="return solonumeros(event);"></asp:TextBox>
                                    <div style="display: block;">
                                ...
                                <td>
                                    <asp:TextBox ID="txtCelular" runat="server" MaxLength="20"  onkeypress="return solonumeros(event);"></asp:TextBox>
                                    <div style="display: block;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTelefonoOficina" runat="server" Width="250px" MaxLength="20"  onkeypress="return solonumeros(event);"></asp:TextBox>
                                    <div style="display: block;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtIngreso" runat="server" MaxLength="15"  onkeypress="return solonumeros(event);"></asp:TextBox>
                                    <div style="display: block;">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvIngreso" runat="server" ErrorMessage="Ingreso aproximado requerido"
                                            ControlToValidate="txtIngreso" Display="Dynamic" ValidationGroup="registroVenta"></asp:RequiredFieldValidator>
                                    </div>
                                </td>
                                <td class="field">
                                    Estatus Laboral
                                ...
                                <td>
                                    ...
                                    <div style="display: block">
                                        <asp:RequiredFieldValidator ID="rfvEstatusLaboral" runat="server" ErrorMessage="Estatus laboral requerido"
                                            ControlToValidate="ddlEstatusLaboral" Display="Dynamic" InitialValue="0" ValidationGroup="registroVenta"></asp:RequiredFieldValidator>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:Panel ID="pnlRegistroPreventa" runat="server">
                                        <asp:CustomValidator ID="cusDatosMinimos" runat="server" ErrorMessage="Debe proporcionar por lo menos un tel&eacute;fono de contacto"
                                            ValidationGroup="registroVenta" Display="Dynamic" ClientValidationFunction="ValidarDatosMinimos"></asp:CustomValidator>
                                        <br />
                                        <p>
                                            <asp:LinkButton ID="lblRegistrarPreventa" runat="server" CssClass="search" ValidationGroup="registroVenta"
                                                OnClientClick="return ValidarDatosYMostrarConfirmacion('datosPersonales', '');"><img src="../img/save_all.png" alt="" />&nbsp;&nbsp;Continuar</asp:LinkButton>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        .DatePickerStyle10 {font-family:Verdana;font-size:8.75pt;padding-bottom:5px;padding-left:5px;padding-right:5px;padding-top:5px}
                            &lt;/style&gt;" DayCellHeight="15" DayCellWidth="31" DayHeaderFormat="Short" DisabledDates=""
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtAtendidoPor" runat="server" MaxLength="100" Width="250px" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                        <div style="display: block;">
                                    ...
                                    <td colspan="2">
                                        <asp:TextBox ID="txtNumIdOperadorCallCenter" runat="server" MaxLength="15"  onkeypress="return solonumeros(event);"></asp:TextBox>
                                        <div style="display: block;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNumPlanillaPreAnalisis" runat="server" MaxLength="12"  onkeypress="return solonumeros(event);"></asp:TextBox>
                                        <div style="display: block;">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNumVentaPlanilla" runat="server" MaxLength="12"  onkeypress="return solonumeros(event);"></asp:TextBox>
                                        <div style="display: block;">
                                ...
                                <tr id="trInfoSerial" runat="server">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNumPagare" runat="server" MaxLength="12"  onkeypress="return solonumeros(event);"></asp:TextBox>
                                        <div style="display: block;">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtSerialTarjeta" runat="server" Width="200px" MaxLength="30"  onkeypress="return solonumeros(event);"></asp:TextBox>
                                        <div style="display: block">
                                ...
                                <tr id="trInfoNovedad" runat="server">
                                    <td class="field">
                                        Tipo de Novedad
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlTipoNovedad" runat="server" Enabled="False" AutoPostBack="true">
                                        <asp:ListItem Text="Seleccione un tipo de novedad" Selected="True"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td class="field">
                                        Observaciones
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtObservacionesNovedad" runat="server" Rows="3" TextMode="MultiLine"
                                            Width="95%" MaxLength="500"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvObservacionesNovedad" runat="server" ErrorMessage="Observaciones de novedad requerido"
                                                ControlToValidate="txtObservacionesNovedad" Display="Dynamic" ValidationGroup="registroNovedades"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr id="trAccionesNovedad" runat="server">
                                    <td class="field">
                                        Acción
                                    </td>
                                    <td>
                                        <asp:LinkButton ID="lbRegistrarNovedad" runat="server" CssClass="search" ValidationGroup="registroNovedades"><img src="../img/add.png" alt="" />&nbsp;Agregar</asp:LinkButton><br />
                                    ...
                                    <td colspan="4">
                                        ...
                                        <p>
                                            <asp:LinkButton ID="lbRegistrarVenta" runat="server" CssClass="search" ValidationGroup="registroVenta"
                                                OnClientClick="return ValidarDatosYMostrarConfirmacion('registroVenta', '¿Realmente desea continuar con el registro de datos?');"><img src="../img/save_all.png" alt="" />&nbsp;Continuar</asp:LinkButton>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:Panel ID="pnlHistoricoVenta" runat="server" width="150%">
                            ...
                            <table class="tabla" width="100%">
                                ...
                                <tr>
                                    <td colspan="4" class="style1">
                                        <br />
                                        <p>
                                            <asp:LinkButton ID="lbCancelarHistorico" runat="server" CssClass="search" 
                                                OnClientClick="return confirm('¿Realmente desea cancelar el registro?\nSe perderá toda la información proporcionada');"><img src="../img/cancelar.png" alt="" />&nbsp;Cancelar</asp:LinkButton>
                                                <asp:LinkButton ID="lbNuevaVenta" runat="server" CssClass="search"><img src="../img/new.png" alt="" />&nbsp;Nuevo</asp:LinkButton>
                                        </p>
                                    </td>
                                </tr>
                            </table>
