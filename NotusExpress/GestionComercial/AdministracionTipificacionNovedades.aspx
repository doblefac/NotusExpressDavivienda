<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdministracionTipificacionNovedades.aspx.vb" Inherits="NotusExpress.AdministracionTipificacionNovedades" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Administrar Tipificación Novedades</title>
...
<body>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                ...
                                                <td style="width: 50%; padding-left: 5px;" align="right">
                                                    <dx:ASPxButton ID="btnNuevo" runat="server" Text="Crear Novedad" AutoPostBack="false">
                                                        <ClientSideEvents Click="function(s,e){ pucNuevoCanal.Show(); txtNombreNovedad.SetText(''); }" />
    ...
    <dx:ASPxCallbackPanel ID="cpGeneral" runat="server" >
        ...
        <PanelCollection>
            <dx:PanelContent>
                <dx:ASPxGridView ID="gvListaNovedades" runat="server" AutoGenerateColumns="False" KeyFieldName="IdNovedad">
                    <ClientSideEvents EndCallback="ActualizarEncabezado" />
                    <Columns>
                        <dx:GridViewCommandColumn VisibleIndex="0">
                            
                        </dx:GridViewCommandColumn>
                        <dx:GridViewDataTextColumn Caption="ID" FieldName="IdNovedad" Name="IdNovedad" VisibleIndex="1"
                            ReadOnly="True">
                            <PropertiesTextEdit MaxLength="50">
                            </PropertiesTextEdit>
                            <EditFormSettings VisibleIndex="0" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Nombre" FieldName="Nombre" Name="Novedad"
                            VisibleIndex="2">
                        ...
                        <dx:GridViewDataComboBoxColumn Caption="Causal Genérica" FieldName="Causal" Name="Causal"
                            VisibleIndex="3" ReadOnly="false">
                            <PropertiesComboBox ValueType="System.Byte" ValueField="idCausal" TextField="descripcion">
                            </PropertiesComboBox>
                    ...
                    <SettingsText CommandEdit="Editar" Title="Listado de Novedades" EmptyDataRow="No se encontraron datos acordes con los filtros de b&amp;uacute;squeda" />
                ...
                <dx:ASPxPopupControl ID="pucNuevoCanal" runat="server" HeaderText="Crear Nueva Novedad"
                                ...
                                <PanelCollection>
                                    <dx:PanelContent>
                                        <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" EnableViewState="false" AlignItemCaptionsInAllGroups="True" RequiredMarkDisplayMode="RequiredOnly">
                                            <Items>
                                                <dx:LayoutGroup Caption="Informaci&oacute;n de la Novedad" GroupBoxDecoration="Box">
                                                    <Items>
                                                        <dx:LayoutItem Caption="Nombre" HelpText="">
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                                                    <dx:ASPxTextBox ID="txtNombreNovedad" runat="server" Width="250px" NullText="Ingrese nombre de la novedad..."
                                                                        ClientInstanceName="txtNombreNovedad" MaxLength="70">
                                                                        <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="Registro"
                                                                            RequiredField-ErrorText="Nombre de novedad requerido" ErrorTextPosition="Bottom">
                                                                            <RequiredField IsRequired="True" />
                                                                            <RegularExpression ValidationExpression="^\s*[a-zA-Z_0-9,;:\.\*\!\¡\?\¿\b\sáéíóúÁÉÍÓÚñÑñÑ\-\#\[\]\(\)\/\\]+\s*$"
                                                                                ErrorText="Nombre de novedad no v&aacute;lido" />
                                                                        </ValidationSettings>
                                                                    </dx:ASPxTextBox>
                                                                </dx:LayoutItemNestedControlContainer>
                                                            </LayoutItemNestedControlCollection>
                                                        </dx:LayoutItem>
                                                        <dx:LayoutItem Caption="Causal Genérica" HelpText="">
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server">
                                                                    <dx:ASPxComboBox ID="cbCausalGenerica" ClientInstanceName="cbCausalGenerica" runat="server">
                                                                    </dx:ASPxComboBox>
                                                                </dx:LayoutItemNestedControlContainer>
                                                            </LayoutItemNestedControlCollection>
                                                        </dx:LayoutItem>
