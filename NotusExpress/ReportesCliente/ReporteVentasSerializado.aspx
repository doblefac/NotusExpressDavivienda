<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteInventarioGerencial.aspx.vb" Inherits="NotusExpress.ReporteInventarioGerencial" %>
...
<head id="Head1" runat="server">
    <title>Reporte Ventas Serializado</title>
...
<body>
    ...
    ClientInstanceName="cbFiltroCiudad" ID="cbFiltroCiudad" Width="300px" AutoPostBack="True"></dx:ASPxComboBox>
                                    ...
                                    <dx:ASPxComboBox ID="cbFiltroProducto" runat="server" ClientInstanceName="cbFiltroProducto"
                                            ValueType="System.Byte" AutoPostBack="False">
                                        </dx:ASPxComboBox>
                                    </td>
                                    <td class="field">
                                        Estado
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxButton ID="btnExpandir" runat="server" ToolTip="Expandir Todos Los Grupos"
                                    ...
                                    <ClientSideEvents Click="function(s, e) { gvInventarioG.PerformCallback('expandir');}" />
                                </dx:ASPxButton>
                            </td>
                            <td>
                                <dx:ASPxButton ID="btnContraer" runat="server" ToolTip="Contraer Todos Los Grupos"
                                    ...
                                    <ClientSideEvents Click="function(s, e) { gvInventarioG.PerformCallback('contraer');}" />
                                </dx:ASPxButton>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                <dx:ASPxGridView ID="gvInventarioG" runat="server" AutoGenerateColumns="False" Font-Size="Small"
                    ClientInstanceName="gvInventarioG">
                    <ClientSideEvents EndCallback="function(s,e){ ActualizarEncabezado(s,e);}" />
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="Producto" FieldName="nombreProducto" VisibleIndex="3">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Subproducto" FieldName="Subproducto" VisibleIndex="4" Visible="false">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="Serial" FieldName="Serial" VisibleIndex="6" Visible="false">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Fecha Asignación" FieldName="fechaGestion" VisibleIndex="7">
                        <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy"></PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Estado" FieldName="resultadoGestion" VisibleIndex="8">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Serial" FieldName="Serial" VisibleIndex="9">
                    ...
                    <Settings ShowTitlePanel="True" ShowHeaderFilterButton="True" ShowHeaderFilterBlankItems="False"
                        ShowGroupPanel="true" />
                    <SettingsText CommandEdit="Editar" Title="Reporte de Ventas Serializado" EmptyDataRow="No se encontraron datos acordes con los filtros de b&amp;uacute;squeda" />
                    <SettingsBehavior EnableCustomizationWindow="true" AutoExpandAllGroups="true" />
                </dx:ASPxGridView>
                <dx:ASPxGridViewExporter ID="gveExportador" runat="server" GridViewID="gvInventarioG">
