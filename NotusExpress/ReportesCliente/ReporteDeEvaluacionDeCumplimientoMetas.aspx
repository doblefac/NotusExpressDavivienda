<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteDeEvaluacionDeCumplimientoMetas.aspx.vb"
    Inherits="NotusExpress.ReporteDeEvaluacionDeCumplimientoMetas" %>
...
<head runat="server">
    <title>Reporte de Evaluación de Cumplimiento de Metas</title>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="cbReporte" ClientInstanceName="cbReporte" runat="server" SelectedIndex="0" ValueType="System.String"
                                            ...
                                            <Items>
                                                ...
                                                <dx:ListEditItem Value="vpp" Text="Cifras Por Punto" />
                        ...
                        <td>
                            <dx:ASPxPivotGrid ID="pgReporteCifras" ClientInstanceName="pgReporteCifras" runat="server"
                                ...
                                <Fields>
                                    ...
                                    <dx:PivotGridField ID="fieldPdv" Area="RowArea" AreaIndex="3" Caption="Punto de Venta"
                                        FieldName="PuntoDeVenta" AllowedAreas="RowArea, ColumnArea, FilterArea">
                                    </dx:PivotGridField>
                    ...
                    <ContentCollection>
                        ...
                        <dxcharts:XYDiagram>
                            <axisx visibleinpanesserializable="-1" 
                                title-text="Canal Estrategia Ciudad Punto de Venta Producto">
