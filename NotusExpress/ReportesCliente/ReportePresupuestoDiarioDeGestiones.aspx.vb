...
Public Class ReportePresupuestoDiarioDeGestiones
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            epNotificador.setTitle("Reporte de Presupuesto Diario de Gestiones Comerciales")
    ...
    Private Sub Exportar(ByVal guardarComo As Boolean)
        Try
            ...
            Dim nombreArchivo As String = "ReporteDePresupuestoDiarioDeGestiones"
            Select Case listExportFormat.SelectedIndex
                ...
                Case 2
                    pgeExportador.ExportMhtToResponse(nombreArchivo, "utf-8", "Reporte de Presupuesto Diario de Gestiones", True, guardarComo)
                Case 3
                    pgeExportador.ExportRtfToResponse(nombreArchivo, guardarComo)
                Case 4
                    pgeExportador.ExportTextToResponse(nombreArchivo, guardarComo)
                Case 5
                    pgeExportador.ExportHtmlToResponse(nombreArchivo, "utf-8", "Reporte de Presupuesto Diario de Gestiones", True, guardarComo)
            End Select
        Catch ex As Exception
    ...
    Private Sub EnlazarDatosReporte(Optional ByVal forzarConsulta As Boolean = False)
        Try
            ...
            Dim reportePresupuesto As New ReporteDePresupuestoDiarioDeGestiones
            If Session("reportePresupuestoDiarioGestiones") Is Nothing OrElse forzarConsulta Then
                With reportePresupuesto
                ...
                End With
            Else
                dtDatos = CType(Session("reportePresupuestoDiarioGestiones"), DataTable)
            End If
            With pgReporteCifras
                .DataSource = dtDatos
                .DataBind()
