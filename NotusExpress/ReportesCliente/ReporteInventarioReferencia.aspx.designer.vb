...
Partial Public Class ReporteInventarioReferencia
    ...
    '''<summary>
    '''Control seNumDiasInventario.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents seNumDiasInventario As Global.DevExpress.Web.ASPxSpinEdit
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents gvInventario As Global.DevExpress.Web.ASPxGridView
