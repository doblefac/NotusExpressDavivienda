<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteInventarioGerencia.aspx.vb"
    Inherits="NotusExpress.ReporteInventarioGerencia" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Reporte Ventas Gerencial</title>
            ...
            <dx:PanelContent>
                ...
                <dx:ASPxGridView ID="gvInventarioG" runat="server" AutoGenerateColumns="False" Font-Size="Small"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="Subproducto" FieldName="subproducto" VisibleIndex="3">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Cupo" FieldName="cupo" VisibleIndex="4">
                            <PropertiesTextEdit DisplayFormatString="c0">
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Num. Ventas" FieldName="numVentas" VisibleIndex="5">
                            <PropertiesTextEdit DisplayFormatString="n0">
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Desviación" FieldName="desviacion" VisibleIndex="6">
                            <PropertiesTextEdit DisplayFormatString="n0">
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    ...
                    <Settings ShowTitlePanel="True" ShowHeaderFilterButton="True" ShowHeaderFilterBlankItems="False"
                        ShowGroupPanel="true" />
                    <SettingsText CommandEdit="Editar" Title="Reporte Ventas Gerencial" EmptyDataRow="No se encontraron datos acordes con los filtros de b&amp;uacute;squeda" />
