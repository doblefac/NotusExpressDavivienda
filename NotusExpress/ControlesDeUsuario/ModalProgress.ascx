<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ModalProgress.ascx.vb" Inherits="NotusExpress.ModalProgress" %>
...
<asp:Panel ID="PanelUpdateProgress" runat="server" CssClass="updateProgress" Style="display: none;">
    <div id="divProgress" style="position: relative; padding-top: 10px; text-align: center;">
        <asp:Image ID="imgProgress" runat="server" ImageUrl="~/img/loading_green.gif" />
        <br />Cargando...
    </div>
</asp:Panel>
