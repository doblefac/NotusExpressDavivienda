...
Partial Public Class ReproteGestionVentasCallCenter
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents cmbBase As Global.DevExpress.Web.ASPxComboBox
    ...
    '''<summary>
    '''Control cmbEstadoNotus.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents cmbEstadoNotus As Global.DevExpress.Web.ASPxComboBox
