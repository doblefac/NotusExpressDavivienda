<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteRealceClienteExterno.aspx.vb" Inherits="NotusExpress.ReporteRealceClienteExterno" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidarFiltros(s, e) {
            if (deFechaInicio.GetDate() == null && deFechaFin.GetDate() == null && cmbCampania.GetValue() == null && cmbBase.GetValue() == null) {
                alert('Debe seleccionar por lo menos un filtro de búsqueda.');
            } else {
                if (deFechaInicio.GetDate() == null || deFechaFin.GetDate() == null) {
                    if (cmbCampania.GetValue() == null && cmbBase.GetValue() == null) {
                                    ...
                                    <dx:PanelContent>
                                        ...
                                        <dx:ASPxGridView ID="gvDatos" runat="server" ClientInstanceName="gvDatos" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="fechaSolicitudRealce" Caption="Fecha Solicitud del Realce" ShowInCustomizationForm="True" HeaderStyle-HorizontalAlign="Center"
                                                    VisibleIndex="2">
                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                    <CellStyle HorizontalAlign="Center"></CellStyle>
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn FieldName="idOportunidad" Caption="ID de la oportunidad" ShowInCustomizationForm="True" HeaderStyle-HorizontalAlign="Center"
                                                    VisibleIndex="3">
                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                    <CellStyle HorizontalAlign="Center"></CellStyle>
                                                </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="cliente" Caption="Cliente" ShowInCustomizationForm="True" HeaderStyle-HorizontalAlign="Center"
                                                    VisibleIndex="6">
                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn FieldName="codigoBase" Caption="Código de la base" ShowInCustomizationForm="True" HeaderStyle-HorizontalAlign="Center"
                                                    VisibleIndex="7">
                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                </dx:GridViewDataTextColumn>
                                            </Columns>
