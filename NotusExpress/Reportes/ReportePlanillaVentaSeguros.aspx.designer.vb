...
Partial Public Class ReportePlanillaVentaSeguros
    ...
    '''<summary>
    '''Control txtFiltroIdentificacion.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents txtFiltroIdentificacion As Global.DevExpress.Web.ASPxTextBox
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents cmbAsesor As Global.DevExpress.Web.ASPxComboBox
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents rpEntregas As Global.DevExpress.Web.ASPxRoundPanel
