...
#Region "Class Private Methods"
    ...
    Private Sub CrearCuerpoMensajeHTML()
        Dim value As New ConfigValues("URL_IMAGEN_NOTIFICACION_WEB")
        ...
        With _cuerpo
            ...
            .Append("		ID='Table1'>")
            .Append("		<tr>")
            .Append("			<td width='20%' ><img src='" & url & "img/logoEmpresa.gif'>")
            .Append("			</td>")
...
#Region "Class Public Methods"
    ...
    Public Sub EstablecerValoresPorDefecto()
        ...
        If String.IsNullOrEmpty(_displayName) Then _displayName = "Notificador NOTUS EXPRESS"
        ...
        _clienteSmtp.Host = ConfigurationSettings.AppSettings("servidorCorreo")
        _mensaje.From = New MailAddress(ConfigurationSettings.AppSettings("notificadorEvento"), _displayName)


        If ConfigurationSettings.AppSettings("credenciales") IsNot Nothing Then
            Dim credenciales() As String
            credenciales = ConfigurationSettings.AppSettings("credenciales").Split(";")
