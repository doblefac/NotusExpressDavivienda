...
Namespace General
    ...
    Public Class InfoDenegacionOpcionFuncionalRestringida

#Region "Atributos"

        Private _funcionalidad As String
        Private _nombreControl As String
        Private _denegaciones As DataTable
...
#Region "Propiedades"
        ...
        Public ReadOnly Property ListaDenegaciones As DataTable
            Get
                If _denegaciones Is Nothing Then CargarInformacion()
                Return _denegaciones
            End Get
        End Property
...
#Region "Métodos"
        ...
        Public Sub CargarInformacion()
            ...
            Try
                ...
                With dbManager
                    ...
                    _denegaciones = .ejecutarDataTable("InfoDenegacionOpcionFuncionalRestringida", CommandType.StoredProcedure)
                End With
            Finally
        ...
        Public Function DenegarAcceso(nombreControl As String) As Boolean
            ...
            If contexto.Session("arrIdPerfiles") IsNot Nothing Then
                ...
                If arrPerfiles.Count > 0 Then
                    ...
                    If _denegaciones.Select(filtro).Count > 0 Then Return True
                Else
                    Return True
                End If
            Else
