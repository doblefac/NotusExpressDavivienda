                ...
                Try
                    With dbManager
                        ...
                        If .Reader IsNot Nothing Then
                            If .Reader.Read Then MyBase.AsignarValorAPropiedades(.Reader, "idAsesor", "Asesor")
                            .Reader.Close()
                        End If
                    End With
                Finally
...
#Region "Métodos Publicos"
        ...
        Public Overrides Function Registrar() As General.ResultadoProceso
            ...
            Dim dbManager As New LMDataAccess
            If Me._idCampania > 0 AndAlso Me._idPdvOAsesor > 0 AndAlso Me._anio > 0 AndAlso Me._mes > 0 AndAlso Me._meta >= 0 Then
                Try
                    With dbManager
                        .SqlParametros.Add("@idCampania", SqlDbType.SmallInt).Value = Me._idCampania
                        .SqlParametros.Add("@idPersonaAsesor", SqlDbType.Int).Value = Me._idPdvOAsesor
                        ...
                        .ejecutarNonQuery("RegistrarMetaComercialAsesor", CommandType.StoredProcedure)
            ...
            If Me._meta >= 0 AndAlso idUsuario > 0 Then
                ...
                Try
                    With dbManager
                        ...
                        .SqlParametros.Add("@meta", SqlDbType.Int).Value = Me._meta
                        .SqlParametros.Add("@estado", SqlDbType.Bit).Value = Me._estado
