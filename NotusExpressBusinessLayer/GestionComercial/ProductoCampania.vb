...
Namespace GestionComercial
    ...
    Public Class ProductoCampania

#Region "Atributos"

        Private _idCampania As Long
        Private _idProductoComercial As Long
...
#Region "Propiedades"
        ...
        Public Property IdProductoComercial As Long
            Get
        ...
        Private Sub CargarDatos()
            ...
            Try
                With dbManager
                    ...
                    .ejecutarReader("ObtenerInfoProductoCampania", CommandType.StoredProcedure)
        ...
        Protected Friend Sub CargarResultadoConsulta(ByVal reader As Data.Common.DbDataReader)
            If reader IsNot Nothing Then
                If reader.HasRows Then
                    ...
                    Long.TryParse(reader("idProductoComercial"), _idProductoComercial)
                End If
            End If
        End Sub
