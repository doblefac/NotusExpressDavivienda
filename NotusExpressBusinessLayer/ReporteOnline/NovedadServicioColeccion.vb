...
Public Class NovedadServicioColeccion
...
#Region "Propiedades"
    ...
    Default Public Property Item(ByVal index As Integer) As NovedadServicio
        Get
            Return Me.InnerList.Item(index)
        End Get
        Set(ByVal value As NovedadServicio)
...
#Region "Métodos Privados"
    ...
    Private Function CrearEstructuraDeTabla() As DataTable
        ...
        Dim obj As Type = GetType(NovedadServicio)
...
#Region "Métodos Públicos"
    ...
    Public Sub Insertar(ByVal posicion As Integer, ByVal valor As NovedadServicio)
        Me.InnerList.Insert(posicion, valor)
    End Sub

    Public Sub Add(ByVal valor As NovedadServicio)
        Me.InnerList.Add(valor)
    End Sub


    Public Sub Remover(ByVal valor As NovedadServicio)
        With Me.InnerList
    ...
    Public Function IndiceDe(ByVal identificador As Integer) As Integer
        ...
        For index As Integer = 0 To Me.InnerList.Count - 1
            With CType(Me.InnerList(index), NovedadServicio)
    ...
    Public Function GenerarDataTable() As DataTable
        ...
        Dim obj As NovedadServicio

        For index As Integer = 0 To Me.InnerList.Count - 1
            drAux = dtAux.NewRow
            obj = CType(Me.InnerList(index), NovedadServicio)
            If obj IsNot Nothing Then
                For Each pInfo As PropertyInfo In GetType(NovedadServicio).GetProperties
                    If pInfo.PropertyType.Namespace = "System" Then
    ...
    Public Sub CargarDatos()
        ...
        Try
            ...
            With dbManager
                ...
                .ejecutarReader("ObtenerInfoNovedadServicio", CommandType.StoredProcedure)

                If .Reader IsNot Nothing Then
                    Dim obj As NovedadServicio
                    While .Reader.Read
                        obj = New NovedadServicio
