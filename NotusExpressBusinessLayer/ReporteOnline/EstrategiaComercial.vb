...
Public Class EstrategiaComercial
#Region "Atributos"
        ...
        If Not String.IsNullOrEmpty(Me._nombre.Trim) AndAlso idUsuario > 0 Then
            ...
            Try
                With dbManager
                    ...
                    .SqlParametros.Add("@idCanal", SqlDbType.SmallInt).Value = Me._idCanal
                    .ejecutarNonQuery("RegistrarEstrategiaComercial", CommandType.StoredProcedure)
